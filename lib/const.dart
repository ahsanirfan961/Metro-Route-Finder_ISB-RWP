...
const Map stationColors = {
  'Islamabad International Airport': Colors.orange,
  '26 Number': Colors.orange,
  'Golra': Colors.orange,
  'G-13': Colors.orange,
  'G-12': Colors.orange,
  'G-11': Colors.orange,
  'G-10': Colors.orange,
  'G-9': Colors.orange,
  'Faiz Ahmad Faiz': null,
  'Kashmir Highway': Colors.red,
  'Chaman': Colors.red,
  'Ibn-e-Sina': Colors.red,
  'Katchery': Colors.red,
  'Centaurus': Colors.red,
  'Stock Exchange': Colors.red,
  '7th Avenue': Colors.red,
  'Shaheed-e-Millat': Colors.red,
  'Parade Ground': Colors.red,
  'Pak Secteriat': Colors.red,
  'Khayaban-e-Johar': Colors.red,
  'Potohar': Colors.red,
  'IJP': Colors.red,
  'Faizabad': Colors.red,
  'Shamsabad': Colors.red,
  '6th Road': Colors.red,
  'Rehmanabad': Colors.red,
  'Chandni Chowk': Colors.red,
  'Waris Khan': Colors.red,
  'Committee Chowk': Colors.red,
  'Liaquat Bagh': Colors.red,
